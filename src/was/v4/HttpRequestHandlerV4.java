...
import was.httpserver.HttpReqeust;
...
public class HttpRequestHandlerV4 implements Runnable {
    ...
    private void process() throws IOException {
        try (socket;
            ...
            HttpReqeust request = new HttpReqeust(reader);
    ...
    private void search(HttpReqeust reqeust, HttpResponse response) {
        String query = reqeust.getParameter("q");
